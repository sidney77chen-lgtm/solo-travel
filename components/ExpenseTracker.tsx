...
import { Plus, Wallet, TrendingUp, Calendar, Tag, AlignLeft, DollarSign, RefreshCcw, X, Edit2, Save } from 'lucide-react';
...
const ExpenseTracker: React.FC<ExpenseTrackerProps> = ({ expenses, onAddExpense, onUpdateExpense, onDeleteExpense }) => {
  ...
  return (
    <div className="flex flex-col h-full bg-blue-50 animate-fade-in relative px-6 pt-8">
        ...
        <div className="flex-1 overflow-y-auto no-scrollbar pb-24 space-y-3">
            ...
            {expenses.map((expense) => (
                ...
                >
                    <div 
                        className="bg-white p-4 rounded-xl border-2 border-pop-dark shadow-pop flex items-center justify-between group cursor-pointer hover:shadow-none transition-all h-full"
                    >
        ...
        {isModalOpen && (
            <div className="fixed inset-0 z-50 flex items-end sm:items-center justify-center">
                ...
                <div className="relative bg-white w-full sm:w-[400px] rounded-t-3xl sm:rounded-2xl p-6 shadow-2xl animate-slide-up border-t-4 sm:border-4 border-pop-dark">
                    <div className="flex justify-between items-center mb-6">
