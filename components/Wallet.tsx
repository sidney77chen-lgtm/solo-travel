...
import { Building2, Plane, FileText, X, Calendar, Train, Ticket as TicketIcon, Edit2, Maximize2, Plus, Trash2, StickyNote } from 'lucide-react';
    ...
    <div className="flex flex-col h-full bg-blue-50 animate-fade-in relative px-6 pt-8">
        ...
        {isModalOpen && (
            <div className="fixed inset-0 z-50 flex items-end sm:items-center justify-center">
                ...
                <div className="relative bg-white w-full sm:w-[400px] rounded-t-3xl sm:rounded-2xl p-6 shadow-2xl animate-slide-up border-t-4 sm:border-4 border-pop-dark max-h-[90vh] overflow-y-auto no-scrollbar">
                    <div className="flex justify-between items-center mb-6">
                            ...
                            <div className="flex gap-2 overflow-x-auto no-scrollbar pb-1">
                                {['Flight', 'Hotel', 'Train', 'Event'].map((t) => (
                                    <button
                                        ...
                                        className={`px-4 py-2 rounded-xl text-sm font-black border-2 transition-all whitespace-nowrap shadow-sm ${
                                            type === t 
